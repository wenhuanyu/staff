<template>
	<view>
		...
		<!-- 附件 -->
		<upload-img title="收款凭证" :imgList="imgList" @uploadImg="uploadImg" @delImg="delImg"></upload-img>
...
<script>
	...
	import { netPaymentMethod, netTopayWorkorder, netWatchPayEwm, uploadUrl } from '@/api/api.js'
