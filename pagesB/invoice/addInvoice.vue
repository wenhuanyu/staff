...
<script>
	...
	import { netApprovalProcess, netInvoiceNumber, netAddInvoice} from '@/api/api.js'
	...
	export default{
		...
		methods:{
			...
			//抬头类型
			changeHeader(e){
				this.headerIndex = e.detail.value
			},
			// 详细地址
			detailAddClick() {
				// #ifdef MP-ALIPAY
