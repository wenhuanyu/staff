		...
		<scroll-view scroll-y class="scrollbox">
			<view class="scr_warp">
				<uni-collapse ref="collapse" v-model="activeNames" @change="onChange">
					<uni-collapse-item title="提交人" name="a">
							<view class="listwarp">
					...
					<uni-collapse-item title="报告类型" name="b">
						<view class="listwarp">
							<view 
								class="li" 
					...
					<uni-collapse-item title="时间筛选" name="c">
						<view class="listwarp">
							<view 
								class="li" 
	...
	export default{
		...
		methods:{
			...
			sure() {
				...
				let params = {	
					times:createtime,
					type:this.statusArr[this.statusIndex]?this.statusArr[this.statusIndex]:'',
