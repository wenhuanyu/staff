<template>
	...
	<view class="wrapper" :style="{ 'padding-top': keyboardHeight+'px' }">
		...
		>
			...
			<view class="btn right" @tap="save">确定</view>
        </view>
		
        <uni-popup type="bottom">
			<robin-color-picker :color="color" @confirm="colorChanged" ref="color"></robin-color-picker>
		</uni-popup>
...
export default {
    ...
    data() {
        return {
            ...
            html: '',
            keyboardHeight: 0,
            editorHeight: 0,   //编辑器的高度
			toolbarHeight:0,  //工具栏的高度
            isIOS: false
        };
    },
    watch: {
    ...
    methods: {
        updatePosition(keyboardHeight) {
            ...
            //#endif
            const toolbarHeight =  130 * rpx; //底部工具栏高度
			this.toolbarHeight = toolbarHeight
			
            const bodyHeight = windowHeight - titleHeight;
            this.keyboardHeight = keyboardHeight - toolbarHeight;
            this.editorHeight = keyboardHeight > 0 ? bodyHeight - keyboardHeight : this.autoHideToolbar ? bodyHeight : bodyHeight - toolbarHeight;
		},
        openColor(e) {
